export default {
    ...
    agent: {
        ...
        editor: {
            ...
            builtinAgentNotice:
                'This is a built-in agent. Name and description are read-only, but configuration can be adjusted.',
            ...
            temperatureDesc:
                'Controls randomness in outputs. 0 is most deterministic; 1 is most random',
            ...
            faqStrategyTooltip:
                'When FAQ knowledge bases are present, prioritize FAQ answers over documents',
            faqPriorityEnabledLabel: 'Enable FAQ Priority',
            faqPriorityEnabledDesc:
                'FAQ answers are prioritized over document content to improve accuracy',
            faqDirectAnswerThresholdLabel: 'Direct Answer Threshold',
            faqDirectAnswerThresholdDesc:
                'Use the FAQ answer directly when similarity exceeds this value',
            faqScoreBoostLabel: 'FAQ Score Boost',
            faqScoreBoostDesc: 'Multiply FAQ relevance scores to rank them higher',
            multiTurn: 'Multi-turn Conversation',
            historyTurns: 'History Turns',
            conversationSettingsDesc:
                'Configure multi-turn conversation and query rewrite parameters',
            ...
            rewritePromptSystemDesc:
                'System prompt for query rewriting (leave empty to use default)',
            rewritePromptUserDesc:
                'User prompt template for query rewriting (leave empty to use default)',
            // Retrieval Strategy
            ...
            tools: {
                thinking: {
                    label: 'Thinking',
                    desc: 'Reflective reasoning tool for problem solving'
                },
                todoWrite: { label: 'Plan Tasks', desc: 'Create structured task plans' },
                grepChunks: {
                    label: 'Keyword Search',
                    desc: 'Find documents and chunks by keywords'
                },
                knowledgeSearch: {
                    label: 'Semantic Search',
                    desc: 'Find semantically relevant content'
                },
                listKnowledgeChunks: {
                    label: 'List Document Chunks',
                    desc: 'View full document chunk content'
                },
                queryKnowledgeGraph: {
                    label: 'Query Knowledge Graph',
                    desc: 'Query relationships from the knowledge graph'
                },
                getDocumentInfo: { label: 'Get Document Info', desc: 'View document metadata' },
                databaseQuery: {
                    label: 'Database Query',
                    desc: 'Query information from the database'
                },
                dataAnalysis: {
                    label: 'Data Analysis',
                    desc: 'Analyze data files and summarize insights'
                },
                dataSchema: { label: 'Data Schema', desc: 'View table and file metadata' },
                searchKnowledge: {
                    label: 'Knowledge Search',
                    desc: 'Search content from knowledge base'
                },
                ...
                getRelatedDocuments: {
                    ...
                    desc: 'Get documents related to current document'
                },
                getDocumentContent: {
                    label: 'Get Document Content',
                    desc: 'Get detailed content of specific document'
                },
                knowledgeGraphExtract: {
                    label: 'Knowledge Graph Extract',
                    desc: 'Extract knowledge graph entities and relations from text'
                }
            },
            fileTypes: {
    ...
    graphSettings: {
        ...
        description:
            'Configure entity-relationship extraction to automatically build knowledge graphs from text',
    ...
    knowledgeEditor: {
        ...
        basic: {
            ...
            typeFAQ: 'FAQ Q&A',
            typeDescription:
                'FAQ suits structured Q&A datasets; document type supports file parsing and chunking.',
        ...
        faqImport: {
            ...
            fileTip:
                'Supports JSON / CSV / Excel. CSV/Excel headers: 分类(必填), 问题(必填), 相似问题(选填-多个用##分隔), 反例问题(选填-多个用##分隔), 机器人回答(必填-多个用##分隔), 是否全部回复(选填-默认FALSE), 是否停用(选填-默认FALSE), 是否禁止被推荐(选填-默认False 可被推荐). Also supports old format: standard_question, answers, similar_questions, negative_questions',
...
\
    ...
    model: {
        ...
        builtinDescription:
            'Built-in models are visible to all tenants, sensitive info is hidden, and cannot be edited or deleted.',
