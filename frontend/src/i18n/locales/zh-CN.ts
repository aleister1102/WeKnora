export default {
  ...
  knowledgeBase: {
    ...
    uploadSuccessSimple: "上传成功！",
    uploadFailedSimple: "上传失败！",
    fileExist: "文件已存在",
    allFilesUploaded: "所有文件上传成功（{count}个）",
    allFilesFailed: "所有文件上传失败（{count}个）",
    partialFilesUploaded: "部分文件上传成功（成功：{success}，失败：{fail}）",
    invalidKbId: "缺少知识库ID",
  ...
  chat: {
    ...
    emptyContentWarning: "当前回答为空，无法复制",
    emptyContentWarningSave: "当前回答为空，无法保存到知识库",
    editorOpened: "编辑器已打开",
    copySuccess: "复制成功",
    copyFailed: "复制失败",
  ...
  agent: {
    ...
    editor: {
      builtinAgentHint: "这是内置智能体，名称和描述不可修改，但可以调整配置参数",
      createTitle: "创建智能体",
      editTitle: "编辑智能体",
      basicInfo: "基础设置",
      basicInfoDesc: "配置智能体的基本信息",
      mode: "运行模式",
      agentDesc: "具备思考、推理和工具调用能力的智能 Agent",
      normalDesc: "基于 Prompt 和知识库检索的传统问答模式",
      name: "名称",
      ...
      systemPromptBuiltinHint: "（留空则使用系统默认）",
      availableVariables: "可用变量：",
      clickToInsert: "（点击插入）",
      insertPlaceholder: "（点击插入，或输入 {'{'}{'{'} 唤起列表）",
      ...
      toolsConfig: "工具配置",
      toolsConfigDesc: "配置智能体可以使用的工具",
      knowledgeConfig: "知识库配置",
      knowledgeConfigDesc: "配置智能体关联的知识库",
      webSearchConfig: "网络搜索",
      webSearchConfigDesc: "配置智能体的互联网搜索能力",
      configuration: "配置项",
      ...
      welcomeMessageDesc: "当选择该智能体时显示的欢迎语",
      suggestedPrompts: "推荐问题",
      suggestedPromptsDesc: "为用户推荐的引导词",
      webSearch: "网络搜索",
      ...
      allKnowledgeBases: "全部",
      allKnowledgeBasesDesc: "智能体可访问所有知识库",
      selectedKnowledgeBases: "指定",
      ...
      kbDisabledHint: "（需要配置知识库）",
      mcpServices: "MCP 服务",
      mcpServicesDesc: "选择 Agent 可以调用的 MCP 服务",
      mcpSelectionModeAll: "全部",
      mcpSelectionModeSelected: "指定",
      mcpSelectionModeNone: "禁用",
      selectMcpServices: "选择 MCP 服务",
      selectMcpServicesDesc: "选择要启用的 MCP 服务",
      mcpServicesPlaceholder: "选择 MCP 服务",
      multiTurn: "多轮对话",
      ...
      enableQueryExpansionDesc: "自动扩展查询词以提高召回率",
      enableRewrite: "问题改写",
      ...
      maxCompletionTokensDesc: "模型生成回复的最大Token数量",
      ...
      faqStrategy: "FAQ 优先策略",
      faqStrategyDesc: "当知识库中包含 FAQ（问答对）时，可以启用此策略让 FAQ 答案优先于普通文档",
      enableFaqPriority: "启用 FAQ 优先",
      enableFaqPriorityDesc: "FAQ 答案将优先于普通文档被引用，提高回答准确性",
      faqDirectAnswerThreshold: "直接回答阈值",
      faqDirectAnswerThresholdDesc: "当问题与 FAQ 相似度超过此值时，直接使用 FAQ 答案",
      faqScoreBoost: "FAQ 分数加权",
      faqScoreBoostDesc: "FAQ 结果的相关性分数乘以此系数，使其排序更靠前",
      tools: {
        thinking: {
          label: "思考",
          description: "动态和反思性的问题解决思考工具"
        },
        todo_write: {
          label: "制定计划",
          description: "创建结构化的研究计划"
        },
        grep_chunks: {
          label: "关键词搜索",
          description: "快速定位包含特定关键词的文档和分块"
        },
        knowledge_search: {
          label: "语义搜索",
          description: "理解问题并查找语义相关内容"
        },
        list_knowledge_chunks: {
          label: "查看文档分块",
          description: "获取文档完整分块内容"
        },
        query_knowledge_graph: {
          label: "查询知识图谱",
          description: "从知识图谱中查询关系"
        },
        get_document_info: {
          label: "获取文档信息",
          description: "查看文档元数据"
        ...
        data_analysis: {
          label: "数据分析",
          description: "理解数据文件并进行数据分析"
        },
        data_schema: {
          label: "查看数据元信息",
          description: "获取表格文件的元信息"
        }
      },
      fileTypes: {
        pdf: "PDF 文档",
        ...
        md: "Markdown 文档",
        csv: "逗号分隔值文件",
        xlsx: "Excel 表格 (.xlsx/.xls)",
        jpg: "图片文件 (.jpg/.jpeg/.png)"
      },
      fileTypeLabels: {
        pdf: "PDF",
        docx: "Word",
  ...
  knowledgeEditor: {
    ...
    faq: {
      ...
      items: "条",
      retry: "重试",
      selectEntriesFirst: "请先选中要操作的FAQ条目",
      importInProgress: "导入正在进行中，请等待完成后再试",
      csvParseFailed: "CSV解析失败: {error}",
      modes: {
  ...
  agentSettings: {
    ...
    systemPrompt: {
      ...
      tabHintAlt: "（留空则使用系统默认，使用 {'{'}{'{'}web_search_status{'}'}{'}'} 占位符动态控制网络搜索行为）",
    },
    reset: {
      header: "恢复默认 Prompt",
  ...
  modelSettings: {
    ...
    toasts: {
      ...
      listFailed: "加载模型列表失败",
      builtinNoEdit: "内置模型不能编辑",
      builtinNoDelete: "内置模型不能删除",
    },
