export default {
  ...
  agent: {
    ...
    toolNames: {
      search_knowledge: 'Поиск по знаниям',
      knowledge_search: 'Поиск по знаниям',
      grep_chunks: 'Поиск по шаблону',
      web_search: 'Веб-поиск',
      web_fetch: 'Загрузка веб-страницы',
      get_document_info: 'Получить информацию о документе',
      list_knowledge_chunks: 'Список фрагментов знаний',
      get_related_documents: 'Найти похожие документы',
      get_document_content: 'Получить содержимое документа',
      todo_write: 'Управление планом',
      knowledge_graph_extract: 'Извлечение графа знаний',
      thinking: 'Мышление',
    ...
    title: 'Агенты',
    subtitle: 'Настраивайте и управляйте своими агентами, чтобы персонализировать поведение и возможности диалога',
    createAgent: 'Создать агента',
    builtin: 'Встроенный',
    noDescription: 'Нет описания',
    selectAgent: 'Выбрать агента',
    noAgents: 'Нет агентов',
    manageAgents: 'Управление',
    builtinAgents: 'Встроенные агенты',
    customAgents: 'Пользовательские агенты',
    capabilities: {
      normal: 'Быстрый ответ, прямые ответы',
      agent: 'Многошаговое мышление, глубокий анализ сложных вопросов',
      modelSpecified: 'Модель указана',
      kbCount: 'Указано {count} баз(ы) знаний',
      kbAll: 'Доступ ко всем базам знаний',
      kbDisabled: 'База знаний отключена',
      rerankSpecified: 'Модель ReRank указана',
      webSearchOn: 'Веб-поиск включен',
      webSearchOff: 'Веб-поиск отключен',
      hasPrompt: 'Пользовательский промпт',
      default: 'Конфигурация по умолчанию',
      mcpEnabled: 'Сервисы MCP включены',
      multiTurn: 'Многораундовый диалог',
    },
    type: {
      normal: 'Быстрый ответ',
      agent: 'Умное рассуждение',
    ...
    features: {
      webSearch: 'Веб-поиск включен',
      knowledgeBase: 'База знаний подключена',
      mcp: 'Сервисы MCP включены',
      multiTurn: 'Многораундовый диалог',
    },
    empty: {
      title: 'Нет пользовательских агентов',
      description: 'Нажмите кнопку в правом верхнем углу, чтобы создать своего первого агента',
    },
    delete: {
      confirmTitle: 'Удалить агента',
      confirmMessage: 'Вы уверены, что хотите удалить агента "{name}"? Это действие нельзя отменить.',
      confirmButton: 'Подтвердить удаление',
    },
    messages: {
      created: 'Агент успешно создан',
      updated: 'Агент успешно обновлен',
      deleted: 'Агент удален',
      deleteFailed: 'Не удалось удалить',
      saveFailed: 'Не удалось сохранить',
      builtinReadonly: 'Встроенных агентов нельзя редактировать',
      copied: 'Агент успешно скопирован',
      copyFailed: 'Не удалось скопировать',
      loadFailed: 'Не удалось загрузить конфигурацию',
    },
    editor: {
      builtinAgentHint: 'Это встроенный агент. Имя и описание нельзя изменить, но параметры конфигурации можно настроить.',
      createTitle: 'Создать агента',
      editTitle: 'Редактировать агента',
      basicInfo: 'Основная информация',
      basicInfoDesc: 'Настройте основную информацию об агенте',
      mode: 'Режим работы',
      agentDesc: 'Умный агент с возможностями мышления, рассуждения и вызова инструментов',
      normalDesc: 'Традиционный режим вопрос-ответ на основе промпта и поиска в базе знаний',
      name: 'Имя',
      nameDesc: 'Задайте легко узнаваемое имя для агента',
      description: 'Описание',
      descriptionDesc: 'Кратко опишите назначение и особенности агента',
      systemPrompt: 'Системный промпт',
      systemPromptDesc: 'Пользовательский системный промпт для определения поведения и роли агента',
      systemPromptBuiltinHint: '(Оставьте пустым, чтобы использовать значение по умолчанию)',
      availableVariables: 'Доступные переменные:',
      clickToInsert: '(Нажмите, чтобы вставить)',
      insertPlaceholder: "(Нажмите, чтобы вставить, или введите {'{'}{'{'}}, чтобы вызвать список)",
      contextTemplate: 'Шаблон контекста',
      contextTemplateDesc: 'Определите, как форматировать извлеченное содержимое перед передачей модели',
      contextTemplatePlaceholder: 'Пользовательский шаблон контекста...',
      modelConfig: 'Конфигурация модели',
      modelConfigDesc: 'Настройте параметры модели агента',
      capabilities: 'Возможности и инструменты',
      capabilitiesDesc: 'Настройте возможности и инструменты агента',
      toolsConfig: 'Инструменты',
      toolsConfigDesc: 'Настройте инструменты, доступные агенту',
      knowledgeConfig: 'База знаний',
      knowledgeConfigDesc: 'Настройте базы знаний для агента',
      webSearchConfig: 'Веб-поиск',
      webSearchConfigDesc: 'Настройте возможности веб-поиска для агента',
      configuration: 'Конфигурация',
      namePlaceholder: 'Введите имя агента',
      nameRequired: 'Имя агента обязательно',
      systemPromptRequired: 'Системный промпт обязателен',
      modelRequired: 'Пожалуйста, выберите модель',
      rerankModelRequired: 'Пожалуйста, выберите модель ReRank при использовании базы знаний',
      contextsMissing: "Шаблон контекста должен содержать плейсхолдер {'{'}{'{'}contexts{'}'}{'}'}, когда включена база знаний",
      queryMissingInContext: "Шаблон контекста должен содержать плейсхолдер {'{'}{'{'}query{'}'}{'}'}",
      knowledgeBasesMissing: "Рекомендуется включить плейсхолдер {'{'}{'{'}knowledge_bases{'}'}{'}'} в системный промпт, чтобы модель знала о доступных базах знаний",
      queryMissingInRewrite: "Промпт перезаписи пользователя должен содержать плейсхолдер {'{'}{'{'}query{'}'}{'}'}",
      conversationMissing: "Промпт перезаписи пользователя должен содержать плейсхолдер {'{'}{'{'}conversation{'}'}{'}'}",
      queryMissingInFallback: "Резервный промпт должен содержать плейсхолдер {'{'}{'{'}query{'}'}{'}'}",
      avatar: 'Аватар',
      avatarPlaceholder: 'Введите Emoji или выберите',
      descriptionPlaceholder: 'Введите описание агента',
      model: 'Модель',
      modelDesc: 'Выберите большую языковую модель, используемую агентом',
      modelPlaceholder: 'Выберите модель',
      systemPromptPlaceholder: "Пользовательский системный промпт для определения поведения и роли агента (используйте плейсхолдер {'{'}{'{'}web_search_status{'}'}{'}'} для динамического поведения веб-поиска)",
      defaultPromptHint: 'Оставьте пустым, чтобы использовать следующий системный промпт по умолчанию:',
      defaultContextTemplateHint: 'Оставьте пустым, чтобы использовать следующий шаблон контекста по умолчанию:',
      contextTemplateRequired: 'Шаблон контекста обязателен',
      availablePlaceholders: 'Доступные плейсхолдеры',
      placeholderHint: "Введите {'{'}{'{'}}, чтобы вызвать автодополнение",
      temperature: 'Температура',
      temperatureDesc: 'Контроль случайности вывода, 0 — самый детерминированный, 1 — самый случайный',
      welcomeMessage: 'Приветственное сообщение',
      welcomeMessagePlaceholder: 'Сообщение, отображаемое при выборе этого агента',
      welcomeMessageDesc: 'Приветственное сообщение, отображаемое при выборе этого агента',
      suggestedPrompts: 'Предлагаемые промпты',
      suggestedPromptsDesc: 'Рекомендуемые промпты для пользователей',
      webSearch: 'Веб-поиск',
      webSearchDesc: 'Включите, чтобы позволить агенту искать информацию в интернете',
      webSearchMaxResults: 'Макс. результатов поиска',
      webSearchMaxResultsDesc: 'Максимальное количество результатов для каждого поиска',
      knowledgeBases: 'Базы знаний',
      knowledgeBasesDesc: 'Выберите диапазон баз знаний, к которым агент имеет доступ',
      allKnowledgeBases: 'Все',
      allKnowledgeBasesDesc: 'Агент может обращаться ко всем базам знаний',
      selectedKnowledgeBases: 'Указанные',
      selectedKnowledgeBasesDesc: 'Доступ только к выбранным базам знаний',
      noKnowledgeBase: 'Отключено',
      noKnowledgeBaseDesc: 'Чистый диалог с моделью, без поиска знаний',
      selectKnowledgeBases: 'Выбрать базы знаний',
      selectKnowledgeBasesDesc: 'Выберите базы знаний для привязки',
      supportedFileTypes: 'Поддерживаемые типы файлов',
      supportedFileTypesDesc: 'Ограничьте выбираемые типы файлов, оставьте пустым для поддержки всех типов',
      allFileTypesPlaceholder: 'Все типы',
      rerankModel: 'Модель ReRank',
      rerankModelDesc: 'Используется для переранжирования результатов поиска в базе знаний для лучшей точности',
      rerankModelPlaceholder: 'Выберите модель ReRank',
      maxIterations: 'Макс. итераций',
      maxIterationsDesc: 'Максимальное количество шагов рассуждения при выполнении задач агентом',
      allowedTools: 'Разрешенные инструменты',
      allowedToolsDesc: 'Выберите инструменты, которые агент может использовать',
      kbDisabledHint: '(Требуется настройка базы знаний)',
      mcpServices: 'Сервисы MCP',
      mcpServicesDesc: 'Выберите сервисы MCP, которые агент может вызывать',
      mcpSelectionModeAll: 'Все',
      mcpSelectionModeSelected: 'Указанные',
      mcpSelectionModeNone: 'Отключено',
      selectMcpServices: 'Выбрать сервисы MCP',
      selectMcpServicesDesc: 'Выберите сервисы MCP для включения',
      mcpServicesPlaceholder: 'Выберите сервисы MCP',
      multiTurn: 'Многораундовый диалог',
      multiTurnDesc: 'Сохранять контекст истории диалога при включении',
      historyTurns: 'Раунды истории',
      historyTurnsDesc: 'Сохранять последние раунды диалога в качестве контекста',
      retrievalStrategy: 'Стратегия поиска',
      retrievalStrategyDesc: 'Настройте параметры поиска и ранжирования в базе знаний',
      embeddingTopK: 'Embedding Top K',
      embeddingTopKDesc: 'Максимальное количество результатов, возвращаемых векторным поиском',
      keywordThreshold: 'Порог ключевых слов',
      keywordThresholdDesc: 'Минимальный балл релевантности для поиска по ключевым словам',
      vectorThreshold: 'Порог вектора',
      vectorThresholdDesc: 'Минимальный балл сходства для векторного поиска',
      rerankTopK: 'Rerank Top K',
      rerankTopKDesc: 'Максимальное количество результатов, сохраняемых после переранжирования',
      rerankThreshold: 'Порог ReRank',
      rerankThresholdDesc: 'Минимальный балл релевантности для переранжирования',
      conversationSettings: 'Многораундовый',
      conversationSettingsDesc: 'Настройте параметры многораундового диалога и перезаписи вопросов',
      advancedSettings: 'Расширенные настройки',
      availableContextPlaceholders: 'Доступные плейсхолдеры',
      placeholderQuery: 'Запрос пользователя',
      placeholderContexts: 'Список извлеченного содержимого',
      placeholderCurrentTime: 'Текущее время (формат: 2006-01-02 15:04:05)',
      placeholderCurrentWeek: 'Текущий день недели (например, понедельник)',
      enableQueryExpansion: 'Расширение запроса',
      enableQueryExpansionDesc: 'Автоматически расширять поисковые термины для улучшения полноты поиска',
      enableRewrite: 'Перезапись вопроса',
      enableRewriteDesc: 'Автоматически перезаписывать вопросы пользователя в многораундовом диалоге для разрешения ссылок и дополнения пропусков',
      rewritePromptSystem: 'Системный промпт перезаписи',
      rewritePromptSystemDesc: 'Системный промпт для перезаписи вопроса (оставьте пустым для использования по умолчанию)',
      rewritePromptSystemPlaceholder: 'Оставьте пустым для использования промпта по умолчанию',
      rewritePromptUser: 'Пользовательский промпт перезаписи',
      rewritePromptUserDesc: 'Шаблон пользовательского промпта для перезаписи вопроса (оставьте пустым для использования по умолчанию)',
      rewritePromptUserPlaceholder: 'Оставьте пустым для использования промпта по умолчанию',
      maxCompletionTokens: 'Макс. токенов завершения',
      maxCompletionTokensDesc: 'Максимальное количество токенов, генерируемых моделью',
      fallbackStrategy: 'Резервная стратегия',
      fallbackStrategyDesc: 'Как обрабатывать случаи, когда в базе знаний не найдено релевантного содержимого',
      fallbackStrategyFixed: 'Фиксированный ответ',
      fallbackStrategyModel: 'Сгенерировано моделью',
      fallbackResponse: 'Фиксированный ответ',
      fallbackResponseDesc: 'Фиксированный текст, возвращаемый при невозможности ответить',
      fallbackResponsePlaceholder: 'Извините, я не могу ответить на этот вопрос.',
      fallbackPrompt: 'Резервный промпт',
      fallbackPromptDesc: 'Промпт, используемый для руководства генерацией модели, когда в базе знаний не найдено ответа',
      fallbackPromptPlaceholder: 'Оставьте пустым для использования промпта по умолчанию',
      faqStrategy: 'Стратегия приоритета FAQ',
      faqStrategyDesc: 'Когда база знаний содержит FAQ (пары вопрос-ответ), включите эту стратегию, чтобы отдавать приоритет ответам FAQ перед обычными документами',
      enableFaqPriority: 'Включить приоритет FAQ',
      enableFaqPriorityDesc: 'Ответы FAQ будут иметь приоритет перед обычными документами для повышения точности',
      faqDirectAnswerThreshold: 'Порог прямого ответа',
      faqDirectAnswerThresholdDesc: 'Когда сходство вопроса с FAQ превышает это значение, использовать ответ FAQ напрямую',
      faqScoreBoost: 'Повышение балла FAQ',
      faqScoreBoostDesc: 'Балл релевантности результатов FAQ умножается на этот коэффициент, чтобы ранжировать их выше',
      tools: {
        thinking: {
          label: 'Мышление',
          description: 'Инструмент динамического и рефлексивного мышления для решения проблем'
        },
        todo_write: {
          label: 'План',
          description: 'Создание структурированных планов исследования'
        },
        grep_chunks: {
          label: 'Поиск по ключевым словам',
          description: 'Быстрый поиск документов и фрагментов, содержащих определенные ключевые слова'
        },
        knowledge_search: {
          label: 'Семантический поиск',
          description: 'Понимание вопросов и поиск семантически релевантного содержимого'
        },
        list_knowledge_chunks: {
          label: 'Просмотр фрагментов документа',
          description: 'Получение полного содержимого фрагментов документа'
        },
        query_knowledge_graph: {
          label: 'Запрос к графу знаний',
          description: 'Запрос отношений из графа знаний'
        },
        get_document_info: {
          label: 'Информация о документе',
          description: 'Просмотр метаданных документа'
        },
        database_query: {
          label: 'Запрос к базе данных',
          description: 'Запрос информации в базе данных'
        },
        data_analysis: {
          label: 'Анализ данных',
          description: 'Понимание файлов данных и выполнение анализа данных'
        },
        data_schema: {
          label: 'Просмотр метаинформации данных',
          description: 'Получение метаинформации табличных файлов'
        }
      },
      fileTypes: {
        pdf: 'Документ PDF',
        docx: 'Документ Word (.docx/.doc)',
        txt: 'Текстовый файл (.txt)',
        md: 'Документ Markdown',
        csv: 'Значения, разделенные запятыми (CSV)',
        xlsx: 'Таблица Excel (.xlsx/.xls)',
        jpg: 'Файл изображения (.jpg/.jpeg/.png)'
      },
      fileTypeLabels: {
        pdf: 'PDF',
        docx: 'Word',
    ...
    selector: {
      ...
      builtinSection: 'Встроенные агенты',
      customSection: 'Мои агенты',
      addNew: 'Добавить нового агента',
      current: 'Текущий',
    },
    // Информация о встроенных агентах
    builtinInfo: {
      quickAnswer: {
        name: 'Быстрый ответ',
        description: 'Вопрос-ответ на основе базы знаний RAG для быстрых и точных ответов',
      },
      smartReasoning: {
        name: 'Умное рассуждение',
        description: 'Фреймворк рассуждения ReAct с многошаговым мышлением и вызовом инструментов',
      },
      deepResearcher: {
        name: 'Глубокий исследователь',
        description: 'Сфокусирован на глубоком исследовании и всестороннем анализе, способен создавать планы исследования, осуществлять многомерный поиск информации, глубоко мыслить и предоставлять подробные аналитические отчеты',
      },
      dataAnalyst: {
        name: 'Аналитик данных',
        description: 'Специализируется на анализе данных и визуализации, помогает извлекать ценную информацию из сложных наборов данных',
      },
      knowledgeGraphExpert: {
        name: 'Эксперт по графам знаний',
        description: 'Специализируется на извлечении и запросе отношений сущностей, помогая строить и использовать сложные сети знаний',
      },
      documentAssistant: {
        name: 'Помощник по документам',
        description: 'Сфокусирован на понимании и обобщении документов, помогая быстро находить ключевую информацию в длинных текстах',
      },
    },
  },
  settings: {
  ...
  chat: {
    ...
    noAnswerContent: '(Нет содержания ответа)',
    emptyContentWarning: 'Текущий ответ пуст и не может быть скопирован',
    copySuccess: 'Скопировано в буфер обмена',
    copyFailed: 'Ошибка копирования, скопируйте вручную',
    emptyContentWarningSave: 'Текущий ответ пуст и не может быть сохранен в базу знаний',
    editorOpened: 'Редактор открыт. Пожалуйста, выберите базу знаний и сохраните',
    webSearchResult: 'Результат поиска',
  },
  language: {
    zhCN: '简体中文',
    enUS: 'English',
