export default {
    ...
    knowledgeBase: {
        ...
        originalFileNotSupported:
            'Этот тип файла не поддерживает просмотр исходного файла. Пожалуйста, загрузите для просмотра.',
        ...
        fileUploadEventReceived:
            'Получено событие загрузки файла, загруженный ID базы знаний: {uploadedKbId}, текущий ID базы знаний: {currentKbId}',
        matchingKnowledgeBase: 'Совпадающая база знаний, начинаем обновление списка файлов',
        routeParamChange:
            'Изменение параметров маршрута, повторное получение содержимого базы знаний',
        ...
        responseInterceptorData:
            'Поскольку перехватчик ответа уже вернул data, result является частью данных ответа',
        ...
        fallbackLocalStorageKbId:
            'Если на текущей странице нет ID базы знаний, попытка получить ID базы знаний из настроек в localStorage',
        // Дополнительные переводы для KnowledgeBaseList.vue
        createNewKnowledgeBase: 'Создать базу знаний',
        uninitializedWarning:
            'Некоторые базы знаний не инициализированы, необходимо сначала настроить информацию о моделях в настройках, чтобы добавить документы знаний',
        initializedStatus: 'Инициализирована',
        notInitializedStatus: 'Не инициализирована',
        needSettingsFirst:
            'Необходимо сначала настроить информацию о моделях в настройках, чтобы добавить знания',
        documents: 'Документы',
    ...
    agent: {
        ...
        tools: {
            thinking: {
                label: 'Размышление',
                desc: 'Инструмент рефлексивного мышления для решения задач'
            },
            todoWrite: {
                label: 'Планирование',
                desc: 'Создание структурированных планов исследований'
            },
            grepChunks: {
                label: 'Поиск по ключевым словам',
                desc: 'Быстрый поиск документов и фрагментов по ключевым словам'
            },
            knowledgeSearch: {
                label: 'Семантический поиск',
                desc: 'Понимание вопроса и поиск семантически связанного контента'
            },
            listKnowledgeChunks: {
                label: 'Просмотр фрагментов документов',
                desc: 'Получение полного содержимого фрагментов документов'
            },
            queryKnowledgeGraph: {
                label: 'Запрос к графу знаний',
                desc: 'Запрос отношений из графа знаний'
            },
            getDocumentInfo: {
                label: 'Получение информации о документе',
                desc: 'Просмотр метаданных документа'
            },
            databaseQuery: {
                label: 'Запрос к базе данных',
                desc: 'Запрос информации из базы данных'
            },
            dataAnalysis: {
                label: 'Анализ данных',
                desc: 'Понимание файлов данных и выполнение анализа данных'
            },
            dataSchema: {
                label: 'Просмотр метаданных',
                desc: 'Получение метаданных табличных файлов'
            },
            searchKnowledge: {
                label: 'Поиск по базе знаний',
                desc: 'Поиск соответствующего контента в базе знаний'
            },
            webSearch: { label: 'Веб-поиск', desc: 'Поиск информации в интернете' },
            webFetch: {
                label: 'Получение веб-страницы',
                desc: 'Получение содержимого веб-страницы'
            },
            getRelatedDocuments: {
                label: 'Получение связанных документов',
                desc: 'Получение документов, связанных с текущим'
            },
            getDocumentContent: {
                label: 'Получение содержимого документа',
                desc: 'Получение подробного содержимого указанного документа'
            },
            knowledgeGraphExtract: {
                label: 'Извлечение графа знаний',
                desc: 'Извлечение сущностей и отношений графа знаний из текста'
            }
        },
        answerMessages: {
        ...
        editor: {
            ...
            skillsConfig: 'Skills',
            skillsConfigDesc:
                'Настройка предустановленных Skills для агента, предоставляющих специализированные знания и рабочие процессы',
            ...
            skillsInfoContent:
                'Skills — это предустановленные модули профессиональных знаний, которые предоставляют агенту инструкции, рабочие процессы и инструменты для конкретных областей. При активации агент автоматически загружает соответствующие знания по мере необходимости.'
        }
    },
    settings: {
        title: 'Настройки',
        ...
        configureKbModels:
            'Настройка моделей и параметров разделения документов для этой базы знаний',
    ...
    webSearchSettings: {
        ...
        blacklistDescription:
            'Исключите домены или URL из результатов. По одному в строке. Поддерживаются подстановки (*) и регулярные выражения (/pattern/).',
    ...
    graphSettings: {
        ...
        description:
            'Настройте извлечение сущностей и отношений для автоматического построения графа знаний из текста',
    ...
    initialization: {
        ...
        baseUrl: 'Base URL',
        baseUrlPlaceholder:
            'Например: https://api.openai.com/v1, удалите часть /chat/completions в конце URL',
        ...
        embeddingWarning:
            'В базе знаний уже есть файлы, невозможно изменить конфигурацию модели встраивания',
        ...
        testDescription:
            'Загрузите изображение для тестирования функций описания изображений и распознавания текста модели VLM',
        ...
        systemWillExtract:
            'Система будет извлекать соответствующие сущности и отношения из текста в соответствии с выбранными типами отношений',
        extractionExample: 'Пример извлечения',
        sampleText: 'Пример текста',
        sampleTextPlaceholder:
            'Введите текст для анализа, например: "Красный особняк", также известный как "Сон в красном тереме", является одним из четырех великих классических произведений китайской литературы, написанным Цинь Сюэцином в династии Цин...',
        generateRandomText: 'Сгенерировать случайный текст',
        ...
        waitForDownloads:
            'Пожалуйста, дождитесь завершения загрузки всех моделей Ollama перед обновлением конфигурации',
        ...
        knowledgeBaseIdMissingCannotSave:
            'Отсутствует ID базы знаний, невозможно сохранить конфигурацию',
        ...
        multimodalConfigIncomplete:
            'Мультимодальная конфигурация неполная, пожалуйста, завершите мультимодальную конфигурацию перед загрузкой изображения',
        ...
        extractionFailedCheckNetwork:
            'Извлечение не удалось, проверьте сетевое соединение или формат текста',
        ...
        knowledgeBaseDescriptionLength:
            'Длина описания базы знаний не может превышать 200 символов',
        ...
        dimensionMustBeInteger:
            'Размерность должна быть допустимым целым числом, обычно 768, 1024, 1536, 3584 и т.д.',
        ...
        knowledgeBaseSettingsModeMissingId:
            'В режиме настроек базы знаний отсутствует ID базы знаний',
        ...
        chunkSizeDesc:
            'Размер каждого текстового блока. Большие блоки сохраняют больше контекста, но могут снизить точность поиска.',
        chunkOverlapDesc:
            'Количество символов, перекрывающихся между соседними блоками. Помогает сохранить контекст на границах блоков.',
        selectRelationType: 'Выберите тип отношения'
    },
    auth: {
        login: 'Вход',
        ...
        registerSuccess:
            'Регистрация успешна! Система создала для вас эксклюзивного арендатора, пожалуйста, войдите',
        registerFailed: 'Ошибка регистрации',
        subtitle:
            'Фреймворк понимания документов и семантического поиска на основе больших моделей',
        ...
        forgotPasswordNotAvailable:
            'Функция восстановления пароля временно недоступна, пожалуйста, свяжитесь с администратором'
    },
    authStore: {
        errors: {
    ...
    tenant: {
        ...
        viewSystemInfo:
            'Просмотр информации о версии системы и конфигурации учётной записи пользователя',
        version: 'Версия',
        ...
        apiKey: 'API Key',
        keepApiKeySafe:
            'Пожалуйста, храните ваш API Key в безопасности, не раскрывайте его в общественных местах или репозиториях кода',
        ...
        useApiKey:
            'Используйте ваш API Key для начала разработки, просмотрите полную документацию API и примеры кода.',
    ...
    knowledgeEditor: {
        ...
        basic: {
            ...
            typeDescription:
                'FAQ подходит для структурированных Q&A; документальный тип поддерживает загрузку файлов и разбиение.',
        ...
        faqImport: {
            ...
            fileTip:
                'Поддерживаются JSON / CSV / Excel. Заголовки CSV/Excel: 分类(必填), 问题(必填), 相似问题(选填-多个用##分隔), 反例问题(选填-多个用##分隔), 机器人回答(必填-多个用##分隔), 是否全部回复(选填-默认FALSE), 是否停用(选填-默认FALSE), 是否禁止被推荐(选填-默认False 可被推荐). Также поддерживается старый формат: standard_question, answers, similar_questions, negative_questions',
        ...
        chunking: {
            ...
            overlapDescription:
                'Количество перекрывающихся символов между соседними блоками (0-500)',
        ...
        advanced: {
            ...
            multimodal: {
                ...
                description:
                    'Включите понимание мультимедийного контента, такого как изображения и видео',
                ...
                storageTypeDescription:
                    'Выберите способ хранения мультимодальных файлов (MinIO или Tencent Cloud COS)',
                storageTypeOptions: {
                    minio: 'MinIO',
                    cos: 'Tencent Cloud COS'
                },
                minioDisabledWarning:
                    'MinIO не включен. Автоматически переключено на Tencent Cloud COS. Чтобы использовать MinIO, сначала включите его в конфигурации системы.',
                minio: {
    ...
    agentSettings: {
        ...
        description:
            'Настройте поведение и параметры AI Agent. Эти параметры применяются ко всем чатам с включённым режимом Agent.',
        status: {
            label: 'Статус Agent',
            ready: 'Готов',
            notReady: 'Не готов',
        ...
        systemPrompt: {
            ...
            disabledHint:
                'Сейчас используется промпт по умолчанию. Включите пользовательский, чтобы применить содержимое ниже.',
            placeholder:
                'Введите системный промпт или оставьте пустым для значения по умолчанию...',
