export default {
    ...
    agent: {
        ...
        tools: {
            thinking: { label: '사고', desc: '문제 해결을 위한 동적 및 반성적 사고 도구' },
            todoWrite: { label: '계획 수립', desc: '구조화된 연구 계획 작성' },
            grepChunks: { label: '키워드 검색', desc: '키워드로 문서 및 청크 검색' },
            knowledgeSearch: {
                label: '의미 검색',
                desc: '질문을 이해하고 의미적으로 관련된 내용 검색'
            },
            listKnowledgeChunks: { label: '문서 청크 보기', desc: '문서의 전체 청크 내용 확인' },
            queryKnowledgeGraph: { label: '지식 그래프 쿼리', desc: '지식 그래프에서 관계 쿼리' },
            getDocumentInfo: { label: '문서 정보 가져오기', desc: '문서 메타데이터 확인' },
            databaseQuery: { label: '데이터베이스 쿼리', desc: '데이터베이스 정보 쿼리' },
            dataAnalysis: { label: '데이터 분석', desc: '데이터 파일 이해 및 분석 수행' },
            dataSchema: {
                label: '데이터 메타 정보 보기',
                desc: '테이블 파일의 메타 정보 가져오기'
            },
            searchKnowledge: { label: '지식베이스 검색', desc: '지식베이스에서 관련 내용 검색' },
            webSearch: { label: '웹 검색', desc: '인터넷에서 정보 검색' },
            webFetch: { label: '웹 페이지 가져오기', desc: '웹 페이지 내용 가져오기' },
            getRelatedDocuments: {
                label: '관련 문서 가져오기',
                desc: '현재 문서와 관련된 문서 가져오기'
            },
            getDocumentContent: {
                label: '문서 내용 가져오기',
                desc: '지정된 문서의 상세 내용 가져오기'
            },
            knowledgeGraphExtract: {
                label: '지식 그래프 추출',
                desc: '텍스트에서 지식 그래프 엔티티 및 관계 추출'
            }
        },
        answerMessages: {
