export default {
  ...
  agent: {
    ...
    tools: {
      ...
      knowledgeSearch: { label: "의미 검색", desc: "질문을 이해하고 의미적으로 관련된 내용 검색" },
      ...
      dataSchema: { label: "데이터 메타 정보 보기", desc: "테이블 파일의 메타 정보 가져오기" },
      ...
      getRelatedDocuments: { label: "관련 문서 가져오기", desc: "현재 문서와 관련된 문서 가져오기" },
      getDocumentContent: { label: "문서 내용 가져오기", desc: "지정된 문서의 상세 내용 가져오기" },
      knowledgeGraphExtract: { label: "지식 그래프 추출", desc: "텍스트에서 지식 그래프 엔티티 및 관계 추출" },
    },
    answerMessages: {
