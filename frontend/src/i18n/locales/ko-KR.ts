export default {
  ...
  chat: {
    ...
    processError: "처리 오류",
    sessionExcerpt: "세션 발췌",
    noAnswerContent: "(답변 내용 없음)",
    emptyContentWarning: "현재 답변이 비어 있어 복사할 수 없습니다",
    copySuccess: "클립보드에 복사되었습니다",
    copyFailed: "복사 실패, 수동으로 복사해 주세요",
    emptyContentWarningSave: "현재 답변이 비어 있어 지식베이스에 저장할 수 없습니다",
    editorOpened: "편집기가 열렸습니다. 지식베이스를 선택한 후 저장해 주세요",
    webSearchResult: "검색 결과",
  },
  agent: {
    taskLabel: "작업:",
    copy: "복사",
    ...
    toolNames: {
      ...
      list_knowledge_chunks: '지식 청크 목록',
      get_related_documents: '관련 문서 찾기',
      get_document_content: '문서 내용 가져오기',
      todo_write: '계획 관리',
      knowledge_graph_extract: '지식 그래프 추출',
      thinking: '사고',
      get_document: '문서 가져오기',
      list_chunks: '청크 목록'
    },
    summary: {
    ...
    title: "에이전트",
    subtitle: "대화 동작 및 기능을 사용자 지정하도록 에이전트를 구성하고 관리합니다",
    createAgent: "에이전트 생성",
    builtin: "내장",
    noDescription: "설명 없음",
    selectAgent: "에이전트 선택",
    ...
    capabilities: {
      normal: "빠른 응답, 직접 답변",
      agent: "다단계 사고, 복잡한 질문에 대한 심층 분석",
      modelSpecified: "모델 지정됨",
      kbCount: "{count}개의 지식베이스 지정됨",
      kbAll: "모든 지식베이스 접근 가능",
      kbDisabled: "지식베이스 비활성화됨",
      rerankSpecified: "ReRank 모델 지정됨",
      webSearchOn: "웹 검색 활성화됨",
      webSearchOff: "웹 검색 비활성화됨",
      hasPrompt: "사용자 정의 프롬프트",
      default: "기본 구성",
      mcpEnabled: "MCP 서비스 활성화됨",
      multiTurn: "다회차 대화",
    },
    type: {
      normal: "빠른 답변",
    ...
    features: {
      webSearch: "웹 검색 활성화됨",
      knowledgeBase: "지식베이스 연결됨",
      mcp: "MCP 서비스 활성화됨",
      multiTurn: "다회차 대화",
    },
    empty: {
      title: "사용자 정의 에이전트 없음",
      description: "오른쪽 상단의 버튼을 클릭하여 첫 번째 에이전트를 만드세요",
    },
    delete: {
    ...
    editor: {
      builtinAgentHint: "이것은 내장 에이전트입니다. 이름과 설명은 수정할 수 없지만 구성 파라미터는 조정할 수 있습니다.",
      createTitle: "에이전트 생성",
      editTitle: "에이전트 편집",
      basicInfo: "기본 정보",
      basicInfoDesc: "에이전트 기본 정보 구성",
      mode: "실행 모드",
      agentDesc: "사고, 추론 및 도구 호출 능력을 갖춘 스마트 에이전트",
      normalDesc: "프롬프트 및 지식베이스 검색을 기반으로 하는 전통적인 Q&A 모드",
      name: "이름",
      nameDesc: "에이전트를 쉽게 식별할 수 있는 이름을 설정하세요",
      description: "설명",
      descriptionDesc: "에이전트의 용도와 특징을 간략하게 설명하세요",
      systemPrompt: "시스템 프롬프트",
      systemPromptDesc: "에이전트의 동작과 역할을 정의하는 사용자 정의 시스템 프롬프트",
      systemPromptBuiltinHint: "(시스템 기본값을 사용하려면 비워 두세요)",
      availableVariables: "사용 가능한 변수:",
      clickToInsert: "(클릭하여 삽입)",
      insertPlaceholder: "(클릭하여 삽입하거나 {'{'}{'{'}를 입력하여 목록 표시)",
      contextTemplate: "컨텍스트 템플릿",
      contextTemplateDesc: "모델에 전달하기 전에 검색된 콘텐츠의 형식을 정의합니다",
      contextTemplatePlaceholder: "사용자 정의 컨텍스트 템플릿...",
      modelConfig: "모델 구성",
      modelConfigDesc: "이 에이전트가 사용할 LLM 모델 및 매개변수 구성",
      knowledgeBase: "지식베이스",
      knowledgeBaseDesc: "이 에이전트가 접근할 수 있는 지식베이스 선택",
      allKnowledgeBases: "모든 지식베이스",
      specifiedKnowledgeBases: "지정된 지식베이스",
      noKnowledgeBase: "지식베이스 없음",
      selectKnowledgeBase: "지식베이스 선택",
      capabilities: "능력 및 도구",
      capabilitiesDesc: "에이전트의 확장 기능 활성화",
      webSearch: "웹 검색",
      webSearchDesc: "인터넷에서 최신 정보를 검색하여 답변 보완",
      mcpServices: "MCP 서비스",
      mcpServicesDesc: "외부 도구 및 데이터 소스에 접근하기 위한 Model Context Protocol 서비스 활성화",
      mcpEmpty: "사용 가능한 MCP 서비스가 없습니다. 설정에서 먼저 구성하세요.",
      saveAgent: "에이전트 저장",
      saving: "저장 중...",
      rerankModel: "재정렬 모델",
      rerankModelDesc: "검색 결과의 정확도를 높이기 위해 재정렬 모델 사용",
      searchConfig: "검색 구성",
      searchConfigDesc: "지식베이스 검색 전략 및 매개변수 구성",
      topK: "Top K",
      topKDesc: "검색할 가장 관련성 높은 청크 수",
      scoreThreshold: "점수 임계값",
      scoreThresholdDesc: "이 점수보다 낮은 검색 결과는 무시됩니다 (0-1)",
      multiTurn: "다회차 대화",
      multiTurnDesc: "이전 대화 맥락을 기억하여 연속적인 질문에 답변",
      retrievalStrategy: "검색 전략",
      retrievalStrategyDesc: "지식베이스 검색 및 정렬 파라미터 구성",
      embeddingTopK: "벡터 리콜 수",
      embeddingTopKDesc: "벡터 검색에서 반환할 최대 결과 수",
      keywordThreshold: "키워드 임계값",
      keywordThresholdDesc: "키워드 검색의 최소 관련성 점수",
      vectorThreshold: "벡터 임계값",
      vectorThresholdDesc: "벡터 검색의 최소 유사도 점수",
      rerankTopK: "재정렬 수",
      rerankTopKDesc: "재정렬 후 유지할 최대 결과 수",
      rerankThreshold: "재정렬 임계값",
      rerankThresholdDesc: "재정렬의 최소 관련성 점수",
      conversationSettings: "다회차 대화",
      conversationSettingsDesc: "다회차 대화 및 질문 재작성 관련 파라미터 구성",
      advancedSettings: "고급 설정",
      availableContextPlaceholders: "사용 가능한 컨텍스트 자리 표시자",
      ...
      enableQueryExpansionDesc: "리콜율을 높이기 위해 쿼리 단어를 자동으로 확장",
      enableRewrite: "질문 재작성",
      enableRewriteDesc: "다회차 대화 시 사용자 질문을 자동으로 재작성하여 지칭 해소 및 생략 보완",
      rewritePromptSystem: "재작성 시스템 프롬프트",
      rewritePromptSystemDesc: "질문 재작성을 위한 시스템 프롬프트 (비워 두면 기본값 사용)",
      rewritePromptSystemPlaceholder: "시스템 기본 프롬프트를 사용하려면 비워 두세요",
      rewritePromptUser: "재작성 사용자 프롬프트",
      rewritePromptUserDesc: "질문 재작성을 위한 사용자 프롬프트 템플릿 (비워 두면 기본값 사용)",
      rewritePromptUserPlaceholder: "시스템 기본 프롬프트를 사용하려면 비워 두세요",
      maxCompletionTokens: "최대 생성 토큰 수",
      maxCompletionTokensDesc: "모델이 생성하는 답변의 최대 토큰 수",
      fallbackStrategy: "대체 전략",
      fallbackStrategyDesc: "지식베이스에서 관련 내용을 찾을 수 없을 때의 처리 방식",
      fallbackStrategyFixed: "고정 답변",
      fallbackStrategyModel: "모델 생성",
      fallbackResponse: "고정 답변 내용",
      fallbackResponseDesc: "답변할 수 없을 때 반환할 고정 텍스트",
      fallbackResponsePlaceholder: "죄송합니다. 해당 질문에 답변할 수 없습니다.",
      fallbackPrompt: "대체 프롬프트",
      fallbackPromptDesc: "지식베이스에서 답을 찾을 수 없을 때 모델이 답변을 생성하도록 유도하는 프롬프트",
      fallbackPromptPlaceholder: "시스템 기본 프롬프트를 사용하려면 비워 두세요",
      faqStrategy: "FAQ 우선 전략",
      faqStrategyDesc: "지식베이스에 FAQ(문답 쌍)가 포함된 경우, FAQ 답변이 일반 문서보다 우선하도록 이 전략을 활성화할 수 있습니다",
      enableFaqPriority: "FAQ 우선 활성화",
      enableFaqPriorityDesc: "FAQ 답변이 일반 문서보다 우선적으로 참조되어 답변 정확도가 향상됩니다",
      faqDirectAnswerThreshold: "직접 답변 임계값",
      faqDirectAnswerThresholdDesc: "질문과 FAQ의 유사도가 이 값을 초과하면 FAQ 답변을 직접 사용합니다",
      faqScoreBoost: "FAQ 점수 가중치",
      faqScoreBoostDesc: "FAQ 결과의 관련성 점수에 이 계수를 곱하여 순위를 높입니다",
      tools: {
        thinking: {
          label: "사고",
          description: "동적이고 반성적인 문제 해결 사고 도구"
        },
        todo_write: {
          label: "계획 수립",
          description: "구조화된 연구 계획 생성"
        },
        grep_chunks: {
          label: "키워드 검색",
          description: "특정 키워드가 포함된 문서 및 청크를 빠르게 찾기"
        },
        knowledge_search: {
          label: "시맨틱 검색",
          description: "질문을 이해하고 시맨틱하게 관련된 콘텐츠 찾기"
        },
        list_knowledge_chunks: {
          label: "문서 청크 보기",
          description: "문서의 전체 청크 콘텐츠 가져오기"
        },
        query_knowledge_graph: {
          label: "지식 그래프 조회",
          description: "지식 그래프에서 관계 조회"
        },
        get_document_info: {
          label: "문서 정보 가져오기",
          description: "문서 메타데이터 보기"
        },
        database_query: {
          label: "데이터베이스 조회",
        ...
        data_analysis: {
          label: "데이터 분석",
          description: "데이터 파일 이해 및 데이터 분석 수행"
        },
        data_schema: {
          label: "데이터 메타 정보 보기",
          description: "표 형식 파일의 메타 정보 가져오기"
        }
      },
      fileTypes: {
        pdf: "PDF 문서",
        docx: "Word 문서 (.docx/.doc)",
        txt: "텍스트 파일 (.txt)",
        md: "Markdown 문서",
        csv: "쉼표로 구분된 값 파일",
        xlsx: "Excel 스프레드시트 (.xlsx/.xls)",
        jpg: "이미지 파일 (.jpg/.jpeg/.png)"
      },
      fileTypeLabels: {
        pdf: "PDF",
        docx: "Word",
  ...
  builtinInfo: {
    quickAnswer: {
      name: "빠른 답변",
      description: "빠르고 정확한 답변을 위한 지식베이스 RAG Q&A",
    },
    smartReasoning: {
      name: "스마트 추론",
      description: "다단계 사고와 도구 호출을 지원하는 ReAct 추론 프레임워크",
    },
    deepResearcher: {
      name: "심층 연구원",
      description: "심층 연구 및 종합 분석에 집중하며, 연구 계획 수립, 다차원 정보 검색, 깊은 사고 및 철저한 분석 보고서 제공 가능",
    },
    dataAnalyst: {
      name: "데이터 분석가",
      description: "데이터베이스 쿼리 및 데이터 분석에 집중하며, 비즈니스 요구사항 이해, SQL 쿼리 생성, 데이터 분석 및 통찰력 제공 가능",
    },
    knowledgeGraphExpert: {
      name: "지식 그래프 전문가",
      description: "지식 그래프 쿼리 및 관계 분석에 집중하며, 엔티티 관계 탐색, 숨겨진 연결 발견 및 지식 네트워크 구축 가능",
    },
    documentAssistant: {
      name: "문서 도우미",
      description: "문서 검색 및 콘텐츠 구성에 집중하며, 문서를 빠르게 찾고 핵심 정보를 추출하며 요약 생성 가능",
    },
  },
  settings: {
    title: "설정",
