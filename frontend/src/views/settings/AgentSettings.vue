      ...
      <div class="setting-row vertical">
        ...
        <div class="setting-control full-width" style="position: relative;">
          ...
          <p class="prompt-tab-hint">
            {{ $t('agentSettings.systemPrompt.tabHintAlt') }}
          </p>
          ...
          <div class="settings-group">
            ...
            <div class="setting-row vertical">
              <div class="setting-info">
                ...
                <p class="desc">{{ $t('conversationSettings.systemPrompt.desc') }}{{ $t('agent.editor.systemPromptBuiltinHint') }}</p>
              </div>
            ...
            <div class="setting-row vertical">
              <div class="setting-info">
                ...
                <p class="desc">{{ $t('conversationSettings.contextTemplate.desc') }}{{ $t('agent.editor.systemPromptBuiltinHint') }}</p>
              </div>
              <div class="setting-control full-width">
                <div class="prompt-textarea-wrapper textarea-with-template">
                  <t-textarea
...
onMounted(async () => {
  ...
  try {
    ...
    MessagePlugin.error(t('agent.messages.loadFailed'))
...
const loadAllModels = async () => {
  ...
  try {
    ...
    MessagePlugin.error(t('modelSettings.toasts.listFailed'))
  } finally {
